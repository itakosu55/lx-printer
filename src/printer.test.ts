...
describe("LXD02Printer Authentication & Print Completion", () => {
  it("should complete authentication sequence correctly", async () => {
    ...
    const macData = [0x5A, 0x01, 0x00, 0x00, 0x11, 0x22, 0x33, 0x44, 0x55, 0x66];
    ...
    const lastCallData1 = mockTx.writeValueWithoutResponse.mock.calls[0][0] as Uint8Array;
    ...
    const lastCallData2 = mockTx.writeValueWithoutResponse.mock.calls[1][0] as Uint8Array;
  ...
  it("should handle print completion (0x06) and send ACK", async () => {
    ...
    const ackData = mockTx.writeValueWithoutResponse.mock.calls[0][0] as Uint8Array;
