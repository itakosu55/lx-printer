...
const btnPrintFile = document.getElementById("btn-print-file") as HTMLButtonElement;
    ...
    try {
        ...
        printer = new LXD02Printer({
            onStatusChange: (status) => {
                ...
                statCharging.style.color = status.isCharging ? "var(--success)" : "inherit";
                ...
                statFlags.style.color = flags.length > 0 ? "var(--error)" : "var(--success)";
            }
        });
